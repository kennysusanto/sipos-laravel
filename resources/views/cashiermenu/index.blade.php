@extends('layouts.app', ['title' => 'Cashier Menu'])
...
@else
    <div class="cashiermenu-layout mt-16">
            ...
            @foreach($items as $item)
                ...
                >
                    ...
                    <div class="menu-card-content">
                        ...
                        <div class="menu-card-price">IDR {{ number_format((float)$item->price, 0, ',', '.') }}</div>
        ...
        <aside class="dashboard-card cashiermenu-sidebar">
            ...
            <form method="POST" action="{{ route('cashiermenu.store') }}" id="cashiermenu-order-form" class="app-form">
                @csrf
                <label for="table_id">Table Number</label>
                <input type="number" min="1" id="table_id" name="table_id" value="{{ old('table_id') }}" placeholder="e.g. 12">
